...
NEW_ROLE_DEFINITION = [:role_super, :role_admin, :role_dev, :role_fin, :role_plm, :role_sales, :role_material_controller, :role_service, :role_buyer, :role_oem, :role_supplier, :role_others]
...
PROCUREMENT_STATUS_DEFINTION = [:status_in_progress, :status_pending_confirmation, :status_submitted, :status_in_delivery, :status_received, :status_closed]
